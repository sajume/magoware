...
export default function (nga, admin) {
    ...
    CustomerAccount.creationView()
        ...
        .fields([
            ...
            nga.field('pin', 'string')
                ...
                .validation({ required: true , pattern:'(?=.*\\d)[0-9]+$' })
                .label('Pin'),
            ...
            nga.field('player', 'choice')
                ...
                .choices([
                    { value: "default", label: 'Default Player' },
                        { value: "exoplayer", label: 'Exo Player' },
                        { value: "visualon", label: 'Visual On' },
                ])
   ...
   /*         nga.field('pin', 'string')
            ...
            nga.field('Salesreports', 'referenced_list')
                ...
                .listActions(['<cancel-subscription type="cancelSubscription" post="entry"></cancel-subscription>']),
